  ...
  return (
    <div ref={wrapperRef} className="relative w-full h-full">
      <button
        ...
        className="w-full h-full bg-slate-700 text-slate-300 p-3 rounded-lg border-2 border-slate-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors uppercase font-bold focus:text-white flex justify-between items-center"
