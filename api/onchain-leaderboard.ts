...
export async function GET(request: Request) {
  ...
  try {
    ...
    // FIX: For viem, when a contract function takes no arguments, the `args` property
    // should be omitted from the `readContract` call to ensure correct type inference.
